...
from src.schemas.masters import MasterCreateRequestSchema,MasterRequestConfirmSchema,MasterUpdateSchema
from src.utils.masters_utils import master_utils
from src.utils.exceptions import MasterRequestAlreadyInProgressError, MasterRequestCooldownError,MasterRequestUniqueError,CancleRequestAndColldownError,NoFound,RoleNotAllowedError,ApplicationNoFound,MasterNoFound,ApplicationApproved
from src.models.enum import UserRoleEnum, MasterRequestStatusEnum


class MastersService(BaseService):

    async def request_application(self, id_user : int, data : MasterCreateRequestSchema, role : str ):
