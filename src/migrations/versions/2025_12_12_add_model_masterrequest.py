...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('masterrequest', sa.Column('bio_short', sa.String(length=50), nullable=False))
    op.add_column('masterrequest', sa.Column('specializations', sa.ARRAY(sa.String()), nullable=False))
    op.add_column('masterrequest', sa.Column('portfolio', sa.ARRAY(sa.String()), nullable=True))
